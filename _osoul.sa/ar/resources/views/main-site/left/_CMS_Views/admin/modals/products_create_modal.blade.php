<a id='products_createModalButton' class='btn btn-default btn-lg btn-block btn-primary' href="#products_create" data-toggle='modal' role='button'>{!! fa2('plus-square',['size'=>0]) !!} أضف منتج جديد</a>


<!--login modal-->
<div id="products_create" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog">
  <div class="modal-content">

      <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
          <h2 class="text-center">{!! fa('cubes') !!} اضف منتج جديد</h2>
      </div>
...
<button type='submit' class="btn btn-primary btn-md btn-block">{!! fa2('thubms-up') !!} أضف</button>
</form>
