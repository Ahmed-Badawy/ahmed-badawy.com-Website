...
slider.ev.on('rsAfterSlideChange', function(event) {
  ...
  if(slider.currSlideId == "4"){
    $(".slide5 .srocket").fadeIn().animate({"opacity":"1","left":"42%"},"slow",function(){
      var $elie = $(".slide5 .srocket"), degree = 90, timer;
      rotate();
      function rotate() {
        ...
        $(".slide5 .srocket").animate({"top":"0px"},"slow","easeOutBounce");
        }
...
slider.ev.on('rsBeforeMove', function() {
  if(slider.currSlideId == "4"){
    $(".slide5 .srocket").fadeOut().css({"left":"-300px","top":"150px","opacity":"0", WebkitTransform: 'rotate(90deg)','-moz-transform': 'rotate(90deg)'})
  }
});
