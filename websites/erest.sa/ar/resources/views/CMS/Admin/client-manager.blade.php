            ...
            <div class='col-sm-12'>
                <div class='page-header'>
                    <h1 class='pull-left'>
                        ...
                        <span>Clients Management System 11</span>
                    </h1>
                </div>
            </div>
        </div>
...
<div aria-label="...">
  <button type="button" class="btn btn-default col-sm-2 btn-primary" ng-click='q=""'>All</button>
    @foreach($email_groups as $group)
  <button type="button" class="btn btn-default col-sm-2 btn-primary" ng-click='q="{{$group}}"'>{{$group}}</button>
    @endforeach
</div>
