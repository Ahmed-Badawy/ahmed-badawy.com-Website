...
//	define('LOAD_FONTS', !Dev);
	...
	define('REMOTE_SITE_URL', "http://erest.sa/ar/");



	$base_url = (Dev) ?  "localhost/_websites/erest.sa/ar/" : "erest.sa/ar/";
...
// dd(base_url);
define('__design_files',base_url."resources/assets/views/");
define('CMS_ASSETS',base_url."resources/assets/CMS/");
define('Uploaded_imgs',base_url."public/site-imgs/_CMS/");

define('ADMIN_EMAIL',"support@erest.sa");
