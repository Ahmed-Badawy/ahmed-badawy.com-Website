<a id='photos_createModalButton' class='btn btn-default btn-lg btn-block btn-primary' href="#photos_create" data-toggle='modal' role='button'>{!! fa2('plus-square',['size'=>0]) !!} أضف صورة للمعرض</a>


<!--login modal-->
<div id="photos_create" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
...
<form action='{{url("admin/create-new/photo")}}' method='post' enctype="multipart/form-data">
