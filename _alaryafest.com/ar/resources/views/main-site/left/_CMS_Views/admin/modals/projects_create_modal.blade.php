<a id='project_createModalButton' class='btn btn-default btn-lg btn-block btn-primary' href="#project_create" data-toggle='modal' role='button'>{!! fa2('plus-square',['size'=>0]) !!} أضف مشروع جديد</a>


<!--login modal-->
<div id="project_create" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog">
  <div class="modal-content">

      <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
          <h2 class="text-center">{!! fa('users') !!} أضف مشروع جديد</h2>
      </div>

<form action='{{url("admin/create-new/project")}}' method='post' enctype="multipart/form-data">
