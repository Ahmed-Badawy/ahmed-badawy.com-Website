    ...
    <div class='col-sm-12'>
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                <h1 class="panel-title"></h1><h2 class='text-center'>المشاريع</h2>
            </div>
            ...
            <div class="panel-body">
                ...
                @foreach($projects as $con)
                    <div class="contr">

                        <div class="col-sm-10">
                            <form method='post' action="{{url('admin/modify-id/project/'.$con->id)}}" enctype="multipart/form-data">
                                ...
                                <a id='project_createModalButton' class='btn btn-default' href="#project_create" data-toggle='modal' role='button'>{!! fa2('plus-square') !!}</a>
                                ...
                                <a myhref="{{url('admin/delete-id/project/'.$con->id)}}" class='btn btn-sm btn-danger delete_button'>{!! fa2('remove') !!} أحذف</a>


                            </form>
                        </div>
                        <img src="{{get_it("site-imgs/_CMS/projects/".$con->img)}}" class='col-sm-2' />
                ...
                @include(get_location('_CMS_Views.admin.modals.projects_create_modal'))
