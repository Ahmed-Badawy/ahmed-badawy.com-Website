        ...
        <div class="row">
            <div class="col-md-7">
                <h1 class='text-center' id="page_header">Ahmed Badawy
                    <p class="lead">Programmer & Fullstack Web Developer</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 text-center">
                            ...
                            <div class="btn-group">
                                ...
                                <button type="button" class="btn btn-default dropdown-toggle arabic" data-toggle="dropdown" aria-expanded="false">
                                    {!! fa2('download') !!}Share My C.V &nbsp;&nbsp;<span class="caret"></span>
                                </button>
