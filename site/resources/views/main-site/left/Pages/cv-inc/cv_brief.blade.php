...
<li> أستطيع تطوير البرمجيات على المنصات التالية: <span class="english">Google Chrome APPs & Extensions برمجيات جوجل, Firefox Addons برمجيات الفيرفوكس</span></li>
<li>القدرة على تنفيذ البرامج الخدمية مثل ( نظم البيع و الشراء - نظم إدارة الصيدليات - نظم إدارة المقاولات - نظم البيع للمطاعم ) بشرط إعطائى الموارد و الوقت الكافى</li>
<li> أستطيع تنفيذ برامج الـ فيسبوك Facebook التى ينفذها المواقع بهدف الدعايا و زيادة عدد الزوار لموقعك ( مثل حملة أسمك على كانز كوكاكولا)</li>
        <li>أستطيع تنفيذ الألعاب البسيطة التى تعمل على متصفح الويب و يمكنك الإطلاع عليها من قائمة الألعاب بموقعى</li>
        <li>خبرة فى تأسيس أنظمة للإستضافة للشركات و المواقع المختلفة عن طريق خدمة الـ Reseller. (أستطيع أن أضيف خدمات الإستضافة لشركتكم)</li>
