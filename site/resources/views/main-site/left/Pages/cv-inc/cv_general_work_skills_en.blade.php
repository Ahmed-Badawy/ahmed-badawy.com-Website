<!-- ******************************************************************** -->
<h3 id="general_work" class='acc_header'>General Work Skills</h3>

<div id="general_work_accordion" class='custom_accordion'>

    <div class='col-sm-12 english'>
        <h3 class="text-center english">General Work Skills</h3>
