...
<div class="row">
    ...
    @include( get_location("projects.recipes.partials.btn-taps" ) )
    @include( get_location("projects.recipes.partials.create" ) )
    @include( get_location("projects.recipes.partials.multi-view" ) )
