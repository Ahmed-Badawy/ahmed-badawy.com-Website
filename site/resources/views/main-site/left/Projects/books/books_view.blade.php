...
<div class="jumbotron">
<div class="col-sm-4">
      <img class="img-thumbnail img-responsive" src='{!! imgs_dir."projects/books.jpg" !!}'>
</div>
...
<div class="modal fade" id="book_info" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
        <h3 class="modal-title" id="myModalLabel">What Does this web app do ?</h3>
      </div>
      <div class="modal-body">
<h3>Book Sharing System!</h3>
<p class='highlight'>It's a system to share books & documents. you can read or download the books & documents & share books with other people. or you can ban/report/delete/categorize books.</p>
<hr>
<p class='arabic' style='color:white' dir='rtl'>ﻫﻮ ﻋﺒﺎﺭﺓ ﻋﻦ ﻧﻈﺎﻡ ﻟﻤﺸﺎﺭﻛﺔ اﻟﻜﺘﺐ ﻭ اﻟﻮﺛﺎﺋﻖ اﻟﻬﺎﻣﺔ. ﻭ ﻳﻤﻜﻨﻚ ﻗﺮاءﺓ اﻟﻜﺘﺐ ﻭ اﻟﻮﺛﺎﺋﻖ ﻣﺒﺎﺷﺮﺓ ﻋﻠﻰ اﻷﻧﺘﺮﻧﺖ ﺃﻭ ﺗﻨﺰﻳﻠﻬﺎ ﻋﻠﻰ ﺟﻬﺎﺯﻙ. ﻫﺬا اﻟﻨﻈﺎﻡ ﻳﺴﺎﻋﺪﻙ ﻋﻠﻰ ﻣﺸﺎﺭﻛﺔ اﻟﻜﺘﺐ ﻭ اﻟﻮﺛﺎﺋﻖ ﻭ ﺗﺼﻨﻴﻔﻬﺎ ﺗﺒﻌﺎ ﻟﻠﻤﺤﺘﻮﻯ. ﻭ ﻳﻤﻜﻨﻚ ﻋﻤﻞ ( ﺣﻈﺮ \ ﺣﺬﻑ \ ﺇﺑﻼﻍ \ ﺗﺼﻨﻴﻒ ) ﻟﻠﻮﺛﺎﺋﻖ ﻭ اﻟﻜﺘﺐ اﻟﻤﺨﺘﻠﻔﺔ.</p>
