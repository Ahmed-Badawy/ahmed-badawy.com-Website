...
<div class="well container" id="project_desc">
	...
	<h3> {!!fa2($logo)!!} Quran Program !</h3>
	<div>
		<p>Quran Program that can play the Quran. also views explanation of quran in arabic & english.</p>
		<p class='arabic' dir='rtl' >برنامج لعرض و قرائة القرأن الكريم و كذلك يظهر التفسير و الترجمة للآيات القرأن الكريم. أضغط على الآية المراد تشغيلها.</p>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h3  class="modal-title" id="myModalLabel"> {!!fa2($logo)!!} Quran Program !</h3>
			</div>
