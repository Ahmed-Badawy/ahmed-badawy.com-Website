...
$(document).ready(function() {
    ...
    $('#editor1,#editor2,#editor3').each( function(index, element)
    {
        $(element).wysiwyg({
            ...
            // Other properties
            selectImage: 'أختر صورة من جهازك',
            placeholderUrl: 'أو ضع هنا الرابط',
...
<!-- ******************************************************************** -->
<form method='post' action="{{url('projects/dynamic2/save')}}">
...
<hr style="color:red"> 
  ...
  <textarea dir='rtl' id="editor1" name="editor" placeholder="Type your text here..." class='widthfix form-control' style='height:400px'>
    {!! $text !!}
  </textarea>
