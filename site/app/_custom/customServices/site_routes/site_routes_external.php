...
$routes_array = [
    "main" => [
        "chrome apps" => [
            "code"=>"chrome-apps",
            "logo"=>'chrome',
            "page_title"=>"Google Chrome APPs",
            "page_name"=>"برامج جوجل كروم",
            "page_desc"=>"هى عبارة عن صفحة تعريفية بجميع برامج جوجل كورم التى قمت بتنفيذها",
            "page_img"=>"external/chrome/main.png",
            "keywords" => [],
            "breadcrumbs"=>[],
            "link"=> route("chrome-apps"),
        ]
    ],
