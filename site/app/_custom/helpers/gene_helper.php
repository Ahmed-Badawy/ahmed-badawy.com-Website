...
function get_share_link($share_type,$share_data){
    ...
    if($share_type==9 || $share_type=="vk") $link = "https://vk.com/share.php?url=$url&title=$title&description=$send_text&image=$img&noparse=true";
    if($share_type==10 || $share_type=="xing") $link = "https://www.xing-share.com/app/user?op=share;sc_p=xing-share;url=$url";
    if($share_type==11 || $share_type=="tumblr") $link = "http://www.tumblr.com/share/link?url=$url&title=$title&description=$send_text";
    if($share_type==12 || $share_type=="reddit") $link = "http://www.reddit.com/submit?url=$url&title=$title";
    return $link;
}
