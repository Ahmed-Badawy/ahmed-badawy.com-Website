...
<?php /*
<link rel='stylesheet' id='argo-main-style-css'  href='Asol/css/style.css?ver=3.9' type='text/css' media='all' />
<link rel='stylesheet' id='argo-main-style-css'  href='Asol/css/style-tow.css' type='text/css' media='all' />
<link rel='stylesheet' id='argo-responsive-css'  href='Asol/css/responsive.css?ver=3.9' type='text/css' media='all' />
<link rel='stylesheet' href='Asol/css/fonts-web/font.css' type='text/css' media='all' /> -->
...
@section("css_section")
            {!! get_it("Asol/css/style.css") !!}
            {!! get_it("Asol/css/style-tow.css") !!}
            {!! get_it("Asol/css/responsive.css") !!}
            {!! get_it("Asol/css/fonts-web/font.css") !!}
@show
...
@section("js_section")
            ...
            {!! get_it("Asol/js/jquery.js") !!}
            {!! get_it("Asol/js/jquery-migrate.min.js") !!}
            {!! get_it("Asol/js/bootstrap.min840f.js") !!}
            {!! get_it("Asol/js/jquery.mCustomScrollbar.concat.min840f.js") !!}
            {!! get_it("Asol/js/jquery.hoverdir840f.js") !!}
            {!! get_it("Asol/js/jquery.isotope.min840f.js") !!}
    <script type='text/javascript' src='http://maps.google.com/maps/api/js?sensor=false'></script>
            {!! get_it("Asol/js/gmap-min840f.js") !!}
            {!! get_it("Asol/js/main840f.js") !!}
            {!! get_it("Asol/js/comment-reply.min.js") !!}
@show
